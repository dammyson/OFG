...
import com.ofidy.ofidyshoppingbrowser.ofidyExtra.ui.fragment.anim.HorizontalItemAnimator;
import com.ofidy.ofidyshoppingbrowser.ofidyExtra.ui.fragment.anim.VerticalItemAnimator;
import com.ofidy.ofidyshoppingbrowser.ofidyExtra.ui.view.BackgroundDrawable;
...
public class TabsFragment extends Fragment implements View.OnClickListener, View.OnLongClickListener, TabsView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (mShowInNavigationDrawer) {
            ...
            TextView textVie = (TextView) view.findViewById(R.id.email);
                textVie.setText(UserPrefs.getInstance(getContext()).getString(UserPrefs.Key.EMAIL));
